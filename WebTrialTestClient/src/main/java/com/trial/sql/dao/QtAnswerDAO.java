...
public class QtAnswerDAO {
	public List<QtAnswer> findAll() {
		...
		String sql = "SELECT T1.ID,T1.QT_CODE,T2.QT_NAME,T1.QT_NO,T1.ANSWER1,T1.ANSWER2,T1.ANSWER3,T1.ANSWER4 "
		...
		try(Connection con = DataBaseConnect.getConnection();
			...
			while(rs.next()) {
				...
				answerList.add(new QtAnswer(id,qtCode,qtName,qtNo,answer1,answer2,answer3,answer4));
			}
